...
import { Wifi, Tv, Users, MapPin, Facebook } from "lucide-react"
  ...
  const services = [
    {
      ...
      description: "Conexión ultra rápida y estable con tecnología de fibra óptica.",
      href: "/internet",
    },
    {
      icon: <Tv className="w-8 h-8" />,
      title: "Internet + TV",
      description: "Paquetes completos con internet de alta velocidad y televisión.",
      href: "/internet-tv",
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Emprendedores",
      description: "Soluciones especiales para empresas y emprendedores.",
      href: "/emprendedores",
    },
  ]
      ...
      <section className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Internet de fibra óptica y televisión de alta calidad en Naranjos, Veracruz. Descubre nuestros planes
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-lg mb-6">
                Contáctanos hoy y descubre la mejor conexión de internet y TV en Naranjos, Veracruz.
              </p>
