        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              Proveedor líder de servicios de internet y televisión en Naranjos, Veracruz. Conectamos hogares y empresas
              con tecnología de fibra óptica de última generación.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/internet-tv" className="text-gray-400 hover:text-white">
                  Internet + TV
                </Link>
              </li>
              <li>
