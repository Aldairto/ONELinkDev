...
export default function InternetPage() {
  const plans = [
    ...
    },
    {
      ...
      price: "$350/mes",
      features: [
        "Velocidad de 50 Mbps simétrico",
      ...
      <section className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Experimenta la velocidad y confiabilidad de nuestra red de fibra óptica. Planes diseñados para satisfacer
            todas tus necesidades de conectividad.
          </p>
        </div>
      </section>
          ...
          {plans.map((plan, index) => (
            <Card key={index} className={`relative ${plan.popular ? "border-blue-500 border-2" : ""}`}>
              ...
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-3xl font-bold text-blue-600">{plan.speed}</CardDescription>
